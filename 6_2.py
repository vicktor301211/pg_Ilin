...
button_rect = pygame.Rect(BUTTON_CENTER[0] - BUTTON_RADIUS, BUTTON_CENTER[1] - BUTTON_RADIUS, BUTTON_RADIUS*2, BUTTON_RADIUS*2)
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if clicking:
                ...
                button_rect.centerx = event.pos[0]
                button_rect.centery = event.pos[1]
